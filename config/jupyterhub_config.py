...
#  
#  .. versionadded:: 0.9
#c.JupyterHub.hub_bind_url = 'http://127.0.0.1:8500'
...
#  
#  .. versionadded:: 0.8
#c.JupyterHub.hub_connect_ip = '194.95.66.235'
...
# c.JupyterHub.subdomain_host = 'jupyter.cyber.me.uk:8100'
...
c.Authenticator.admin_users = set(["mwasil2s", "max", "mmensi2s", "aaster2m", "mmuell2m"])
